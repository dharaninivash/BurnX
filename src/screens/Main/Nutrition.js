...
const getStyles = (colors, typography, ui) => StyleSheet.create({
  ...
  headerSub: { ...typography.caption, color: colors.textSecondary, marginTop: -2, marginBottom: 15 },

  suppLinkCard: { backgroundColor: colors.surface, padding: 15, borderRadius: ui.borderRadius, marginBottom: 20, borderWidth: 1, borderColor: colors.primary, ...ui.shadow },
  suppLinkRow: { flexDirection: 'row', alignItems: 'center' },
  suppLinkIcon: { width: 40, height: 40, borderRadius: 20, backgroundColor: colors.primary, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  suppLinkTextCol: { flex: 1 },
  suppLinkTitle: { fontSize: 15, fontWeight: 'bold', color: colors.textPrimary },
  suppLinkSub: { fontSize: 11, color: colors.textSecondary, marginTop: 2 },

  macroRingCard: { backgroundColor: colors.surface, borderRadius: ui.borderRadius, padding: 18, marginBottom: 20, ...ui.shadow },
  macroRingRow: { flexDirection: 'row', alignItems: 'center' },
  circleContainer: { width: 110, height: 110, borderRadius: 55, borderWidth: 10, borderColor: colors.primary, justifyContent: 'center', alignItems: 'center', marginRight: 18, shadowColor: colors.primary, shadowOpacity: 0.15, shadowRadius: 5 },
  circleInner: { alignItems: 'center' },
  circleCals: { fontSize: 24, fontWeight: '900', color: colors.textPrimary },
  circleGoal: { fontSize: 8, color: colors.textSecondary, fontWeight: '700', marginTop: 2 },
  macroProgressStats: { flex: 1, gap: 10 },
  macroStatBar: {},
  statLabelRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
  statLabel: { fontSize: 10, fontWeight: '900', color: colors.textPrimary },
  statVals: { fontSize: 10, color: colors.textSecondary },
  barBg: { width: '100%', height: 4, backgroundColor: colors.background, borderRadius: 2 },
  barFill: { height: '100%', borderRadius: 2 },

  searchSection: { marginBottom: 20 },
  sectionTitle: { ...typography.title, fontSize: 16, marginBottom: 12 },
  searchRow: { flexDirection: 'row', gap: 10 },
  inputFrame: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, borderRadius: 12, paddingHorizontal: 15, borderHeight: 1, borderColor: colors.border, borderWidth: 1 },
  searchInput: { flex: 1, color: colors.textPrimary, paddingVertical: 14, fontSize: 15 },
  weightFrame: { width: 75, flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, borderRadius: 12, paddingHorizontal: 10, borderHeight: 1, borderColor: colors.border, borderWidth: 1 },
  weightInput: { flex: 1, color: colors.textPrimary, textAlign: 'center', fontSize: 16, fontWeight: 'bold' },
  weightUnit: { fontSize: 13, color: colors.textSecondary, marginLeft: 2, fontWeight: 'bold' },
  
  webSearchBtn: { flexDirection: 'row', backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.primary, borderRadius: 10, paddingVertical: 10, justifyContent: 'center', alignItems: 'center', marginTop: 10 },
  webSearchBtnText: { color: '#FFF', fontWeight: 'bold', fontSize: 12 },

  resultsBox: { backgroundColor: colors.surface, borderRadius: 12, borderWidth: 1, borderColor: colors.border, marginTop: 10, ...ui.shadow, overflow: 'hidden' },
  resultItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 15, borderBottomWidth: 1, borderBottomColor: colors.background },
  resultItemTextCol: { flex: 1, paddingRight: 10 },
  resultItemName: { fontSize: 14, fontWeight: 'bold', color: colors.textPrimary },
  resultItemDetails: { fontSize: 10, color: colors.textSecondary, marginTop: 4 },
  resultItemAddCol: { alignItems: 'flex-end', gap: 4 },
  resultItemCals: { fontSize: 12, fontWeight: '900', color: colors.primary },

  diarySection: { marginBottom: 20 },
  mealCard: { backgroundColor: colors.surface, borderRadius: 14, padding: 15, marginBottom: 12, borderWidth: 1, borderColor: colors.border, ...ui.shadow },
  mealHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  mealTitle: { fontSize: 15, fontWeight: 'bold', color: colors.primary },
  mealCalsSum: { fontSize: 11, color: colors.textSecondary, fontWeight: '700' },
  emptyMealText: { fontSize: 11, color: colors.textSecondary, fontStyle: 'italic', marginTop: 4 },
  loggedFoodList: { gap: 10, marginTop: 8 },
  loggedFoodItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.background, padding: 12, borderRadius: 10, borderHeight: 1, borderColor: colors.border, borderWidth: 1 },
  loggedFoodName: { fontSize: 13, fontWeight: 'bold', color: colors.textPrimary },
  loggedFoodMacros: { fontSize: 10, color: colors.textSecondary, marginTop: 2 },
  deleteFoodBtn: { padding: 4 },

  recommendationsCard: { backgroundColor: colors.surface, borderRadius: ui.borderRadius, padding: 18, marginBottom: 20, ...ui.shadow, borderLeftWidth: 4, borderLeftColor: colors.primary },
  recommendationHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
  recommendationTitle: { fontSize: 14, fontWeight: 'bold', color: colors.textPrimary, marginLeft: 8 },
  recommendationDesc: { fontSize: 11, color: colors.textSecondary, marginBottom: 12 },
  recommendationItemsList: { gap: 10 },
  recItem: { flexDirection: 'row', alignItems: 'flex-start' },
  recItemTextCol: { flex: 1, marginLeft: 8 },
  recItemName: { fontSize: 13, fontWeight: 'bold', color: colors.primary },
  recItemDesc: { fontSize: 11, color: colors.textSecondary, marginTop: 2, lineHeight: 16 },
  ...
  modalTitle: { ...typography.header, color: colors.primary, fontSize: 18 },
  selectedFoodCard: { backgroundColor: colors.background, padding: 15, borderRadius: 12, borderHeight: 1, borderColor: colors.border, borderWidth: 1 },
  selectedFoodName: { fontSize: 16, fontWeight: 'bold', color: colors.textPrimary },
  selectedFoodSpecs: { fontSize: 11, color: colors.textSecondary, marginTop: 4 },
  modalForm: { marginTop: 20, flex: 1 },
  formLabel: { fontSize: 12, fontWeight: 'bold', color: colors.primary, marginBottom: 8 },
  categoryPickerRow: { flexDirection: 'row', justifyContent: 'space-between', gap: 6 },
  pickerBtn: { flex: 1, backgroundColor: colors.background, paddingVertical: 10, borderRadius: 10, alignItems: 'center', borderWidth: 1, borderColor: colors.border },
  pickerBtnActive: { backgroundColor: colors.primary, borderColor: colors.primary },
  pickerBtnText: { color: colors.textSecondary, fontSize: 11, fontWeight: 'bold' },
  portionWeightBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.background, borderRadius: 12, borderWidth: 1, borderColor: colors.border, paddingHorizontal: 15, width: 140, marginTop: 8 },
  modalWeightInput: { color: colors.textPrimary, fontSize: 16, fontWeight: 'bold', paddingVertical: 10, flex: 1, textAlign: 'center' },
  formUnitLabel: { fontSize: 13, color: colors.textSecondary, fontWeight: 'bold' },
  portionFormulaNote: { fontSize: 10, color: colors.textSecondary, fontStyle: 'italic', marginTop: 10, lineHeight: 15 },
  modalSubmitBtn: { flexDirection: 'row', backgroundColor: colors.primary, paddingVertical: 16, borderRadius: 14, justifyContent: 'center', alignItems: 'center', ...ui.shadow },
  modalSubmitText: { color: '#FFF', fontSize: 16, fontWeight: 'bold' },
  customInput: { backgroundColor: colors.background, color: colors.textPrimary, padding: 12, borderRadius: 12, borderWidth: 1, borderColor: colors.border, fontSize: 15 }
});
