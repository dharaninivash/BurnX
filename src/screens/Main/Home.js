...
const getStyles = (colors, typography, ui) => StyleSheet.create({
  ...
  topHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: ui.spacing.l, paddingTop: ui.spacing.s, flexWrap: 'wrap', gap: 10 },
  ...
  readinessRow: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 12 },
  ...
  readinessDetails: { flex: 1, minWidth: 160 },
  ...
  readinessFactorsRow: { flexDirection: 'row', marginTop: ui.spacing.s, flexWrap: 'wrap', gap: 6 },
  factorTag: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surfaceSecondary, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 },
  ...
  equationRow: { flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', marginBottom: ui.spacing.m, flexWrap: 'wrap', gap: 6 },
  eqBox: { alignItems: 'center', minWidth: 60 },
  ...
  cycleRow: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 10 },
  cycleTextCol: { flex: 1, minWidth: 180, marginLeft: ui.spacing.s },
  cycleHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4, flexWrap: 'wrap', gap: 6 },
  ...
  waterQuickBtnsRow: { flexDirection: 'row', justifyContent: 'center', flexWrap: 'wrap', gap: 8 },
  waterQuickBtn: { flex: 1, minWidth: 95, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#0EA5E9', paddingVertical: 10, paddingHorizontal: 6, borderRadius: ui.borderRadiusSm },
